                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 rtl:ml-0 rtl:mr-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ number_format($summary['total_sales'], 0) }} {{ __('IQD') }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 rtl:ml-0 rtl:mr-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ number_format($summary['total_paid'], 0) }} {{ __('IQD') }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="ml-5 rtl:ml-0 rtl:mr-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium {{ $summary['total_balance'] > 0 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400' }}">
                                    {{ number_format($summary['total_balance'], 0) }} {{ __('IQD') }}
                                </dd>
                            </dl>
                        </div>
                    </div>
