...
<body>
    <div class="statement-wrap">
        <div class="card">
            <header>
                <div class="brand">
                    <div class="logo">{{ substr(config('app.name', 'Inventory Management'), 0, 2) }}</div>
                    <div class="company">
                        <h1>{{ config('app.name', 'Inventory Management') }}</h1>
                        <p>{{ __('Your Company Address') }}<br/>{{ __('Your Company City, State ZIP') }}</p>
                        <p class="muted">{{ __('Phone') }}: {{ __('Your Company Phone') }} • {{ __('Your Company Email') }}</p>
                    </div>
                </div>
                ...
                <div class="col small">
                    <div class="box">
                        ...
                        <div style="display:flex;justify-content:space-between;margin-top:6px">
                            <div class="muted">{{ __('Total Purchase Amount') }}</div>
                            <div class="amount">{{ number_format($summary['total_sales'], ) }} {{ $baseCurrency->symbol }}</div>
                        </div>
                        <div style="display:flex;justify-content:space-between;margin-top:6px">
            ...
            <footer>
                ...
                <p class="muted">{{ __('Generated on') }}: {{ now()->format('d-m-Y \a\t H:i') }} | {{ config('app.name', 'Inventory Management') }} - {{ __('Customer Statement') }}</p>
            </footer>
        </div>
    </div>
